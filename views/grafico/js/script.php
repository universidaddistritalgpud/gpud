...
$("#puerto").on("change", function(e) {
	...
	$.ajax({
        url: '<?php echo "http://localhost/workspace/tesisPPP/index.php?url=subirarchivo/ft/information/dfadfafd" ?>', 
        type: "POST", 
        dataType: "json",            
        data: data, 
        contentType: false,                  
...
$("#botonprocesar").on("click", function(e) {
	...
	$.ajax({
        url: '<?php echo "http://localhost/workspace/tesisPPP/index.php?url=subirarchivo/ft/upload/dfadfafd" ?>', 
        type: "POST", 
        dataType: "json",            
        data: data, 
        contentType: false,                  
